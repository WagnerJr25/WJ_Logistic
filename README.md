...
A WJ Logistic é uma empresa fictícia fundada em 2018, especializada em logística e distribuição de produtos eletrônicos na região Nordeste do Brasil.

Com sede em Salvador (BA), seu centro de distribuição é responsável pelo armazenamento e envio de mercadorias para clientes e parceiros comerciais em todos os estados da região.
